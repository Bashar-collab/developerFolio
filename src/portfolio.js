...
const greeting = {
  username: "Bashar Kalla",
  title: "Hi all, I'm Bashar",
  subTitle: emoji(
    "A passionate Backend Developer 🚀 having an experience of building REST APIs and databases with Springboot, MySQL and Postgresql and some other cool libraries and frameworks."
  ),
  resumeLink:
